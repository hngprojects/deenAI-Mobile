...
class AuthService {
  ...
  async requestDeleteAccount(token: string): Promise<OtpResponse> {
    return this.apiCall<OtpResponse>("/users/delete/request", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  async confirmDeleteAccount(
    ...
    return this.apiCall<OtpResponse>("/users/delete/confirm", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
