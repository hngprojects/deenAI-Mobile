...
const COLLECTIONS: HadithCollection[] = [
  {
    ...
    description: 'Compiled by Imam Muslim ibn al-Hajjaj (rahimahullah). Sahih Muslim is one of the two most respected collections of hadith in Sunni Islam, known for its strict criteria of authentication and reliable chains of transmission.',
  ...
  },
  {
    ...
    description: 'Compiled by Imam Muhammad al-Bukhari (rahimahullah). Widely regarded as the most authentic book of hadith after the Qur’an, Sahih al-Bukhari contains rigorously verified narrations covering creed, worship, and daily life.',
  ...
  },
  {
    ...
    description: 'Compiled by Abu Dawud al-Sijistani (rahimahullah). Part of the six major Sunan collections, this work emphasizes hadith relevant to Islamic jurisprudence and often notes scholarly views on authenticity.',
  ...
  },
  {
    ...
    description: "Compiled by Imam al-Tirmidhi (rahimahullah). Jami' at-Tirmidhi is valued for its organization, classification of hadith by authenticity, and the compiler's explanatory remarks on legal and scholarly issues.",
