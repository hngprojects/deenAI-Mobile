...
export default function HadithDetailScreen() {
    ...
    const currentHadithNumber = currentBook.hadiths[currentHadithIndex]?.hadithnumber;
            ...
            Reference: Book {englishHadith.reference.book}, Hadith {englishHadith.reference.hadith}
                ...
                <View style={styles.navigationContainer}>
                    ...
                    <TouchableOpacity
                        style={[
                            styles.navButton,
                            currentHadithIndex === currentBook.hadiths.length - 1 && styles.navButtonDisabled
                        ]}
                        onPress={handleNext}
                    ...
                    >
                        <Text
                            style={[
                                styles.navButtonText,
                                currentHadithIndex === currentBook.hadiths.length - 1 && styles.navButtonTextDisabled
                            ]}
                        >
                            Next
                        </Text>
                        <Ionicons
                            ...
                            size={24}
                            color={currentHadithIndex === currentBook.hadiths.length - 1 ? '#CCC' : theme.color.brand}
                        />
                    </TouchableOpacity>
                </View>
            </ScrollView>
